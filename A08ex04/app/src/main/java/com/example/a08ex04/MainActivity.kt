...
import com.example.a08ex04.api.OutroEndpoint
import com.example.a08ex04.models.OutroUser
import com.example.a08ex04.models.OutroUserResponse
import com.example.a08ex04.utils.OutraNetworkUtils
    ...
    fun buscarUsuarios(numero: Int) {
        ...
        outroEndpoint.getOutrosUsuarios(numero).enqueue(object : Callback<OutroUserResponse> {
            ...
            override fun onResponse(call: Call<OutroUserResponse>, response: Response<OutroUserResponse>) {
                ...
                val outroAdapter = ArrayAdapter(applicationContext, android.R.layout.simple_list_item_1, outrosUsers.map { it.outroName })
